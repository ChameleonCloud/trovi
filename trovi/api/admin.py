...
from ..models import (
    Artifact, ArtifactVersion, ArtifactVersionMigration, ArtifactEvent, 
    ArtifactTag, ArtifactAuthor, ArtifactProject, ArtifactLink, ArtifactRole
)


@admin.register(Artifact)
class ArtifactAdmin(admin.ModelAdmin):
    list_display = ('uuid', 'title', 'visibility', 'created_at', 'updated_at', 'owner_urn')
